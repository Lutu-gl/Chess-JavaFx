    ...
    public ArrayList<Field> getMoves(boolean castle) {
        ...
        if (castle) {
            ...
            if (color.equals(Color.WHITE)) {
                if (permissions[0] && chessboard.isLegal(chessboard.getFields()[line][column-1], field, color) && chessboard.isLegal(chessboard.getFields()[line][column-2], field, color) && !isInCheck() && freeSpace(chessboard.getFields()[line][0], field))
                    availableMoves.add(chessboard.getFields()[line][column - 2]);
                if (permissions[1] && chessboard.isLegal(chessboard.getFields()[line][column+1], field, color) && chessboard.isLegal(chessboard.getFields()[line][column+2], field, color) && !isInCheck() && freeSpace(field, chessboard.getFields()[line][chessboard.getFields().length-1]))
                    availableMoves.add(chessboard.getFields()[line][column + 2]);
            } else {
                if (permissions[2] && chessboard.isLegal(chessboard.getFields()[line][column-1], field, color) && chessboard.isLegal(chessboard.getFields()[line][column-2], field, color) && !isInCheck() && freeSpace(chessboard.getFields()[line][0], field))
                    availableMoves.add(chessboard.getFields()[line][column - 2]);
                if (permissions[3] && chessboard.isLegal(chessboard.getFields()[line][column+1], field, color) && chessboard.isLegal(chessboard.getFields()[line][column+2], field, color) && !isInCheck() && freeSpace(field, chessboard.getFields()[line][chessboard.getFields().length-1]))
                    availableMoves.add(chessboard.getFields()[line][column + 2]);
            }
        }
