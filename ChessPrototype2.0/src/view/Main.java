...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        board.createBoard(size, true, true, 120, 120, 0, 0); //In Sekunden!
...
//        fen = "6bb/6rk/4N1bb/8/8/K7/8/8 w - - 0 1"; //fen checkmate in one
        ...
        primaryStage.setScene(ChessboardView.init(size, size, FieldBackground.STANDARD, PieceDesign.SPACE, false));
